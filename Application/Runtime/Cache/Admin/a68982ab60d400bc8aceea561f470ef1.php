            ...
            <form enctype="multipart/form-data" action="" method="post">
                <table width="90%" class="table" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            开始时间：<input type="text" name="start" <?php if(($info["start"]) != "0"): ?>value="<?php echo (date('Y-m-d H:i:s',$info["start"])); ?>"<?php endif; ?> size="20"/>
                            结束时间：<input type="text" name="end"  <?php if(($info["start"]) != "0"): ?>value="<?php echo (date('Y-m-d H:i:s',$info["end"])); ?>"<?php endif; ?> size="20"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            这里加载的中文，那最后就是中文-->
                            <script type="text/javascript" charset="utf-8" src="/Public/ueditor/ueditor.lang/zh-cn/zh-cn.js"></script>
                        ...
                        <td colspan="2" id="showAttr">
                            <table width="90%" align="center" >
                                <?php if(is_array($attr)): $i = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td class="label"><?php if(($vo["attr_type"]) == "2"): ?><a herf="javescript:;" onclick="clonethis(this)"><?php if(($i) == "1"): ?>[+]<?php else: ?>[-]<?php endif; ?></a><?php endif; echo ($vo["attr_name"]); ?>:</td>
                                        <td>
                                            <?php if(($vo["attr_input_type"]) == "1"): ?><input type="text" name="attr[<?php echo ($vo["attr_id"]); ?>][]"
                                                value="<?php echo ($vo["attr_values"]); ?>">
                                                <?php else: ?>
                ...
                <table width="90%" class="table pic" align="center" style="display:none">
                    <tr>
                        ...
                        <td colspan="2">
                            <?php if(is_array($goods_img_list)): $i = 0; $__LIST__ = $goods_img_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="width:100px;float:left;height:100px;margin:0 10px;">
                            <img src="/<?php echo ($vo["goods_thumb"]); ?>" width="100">
