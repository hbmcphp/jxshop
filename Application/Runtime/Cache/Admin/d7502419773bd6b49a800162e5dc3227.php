    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td align="center">
                <?php if(($vo["id"]) > "1"): ?><a href="<?php echo U('edit','admin_id='.$vo['id']);?>" >编辑</a>
                <a href="<?php echo U('dels','admin_id='.$vo['id']);?>" onclick="return confirm('你确定要删除:<?php echo ($vo["role_name"]); ?>')" title="">删除</a></td><?php endif; ?>
