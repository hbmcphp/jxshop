...
<body>
<h1>
    <span class="action-span"><a href="">添加新角色</a></span>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="<?php echo U('edit','role_id='.$vo['id']);?>" target="_blank" title="">编辑</a>
                <a href="<?php echo U('dels','role_id='.$vo['id']);?>" onclick="return confirm('你确定要删除:<?php echo ($vo["role_name"]); ?>')" title="">删除</a></td><?php endif; ?>
