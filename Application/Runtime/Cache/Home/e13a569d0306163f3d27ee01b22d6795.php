...
<div class="topnav">
	<div class="topnav_bd w990 bc">
		...
		<div class="topnav_right fr">
			<ul>
				<?php if(empty($_SESSION['user_id'])): ?><li>您好，欢迎来到京西！[<a href="<?php echo U('User/login');?>">登录</a>] [<a href="<?php echo U('User/regist');?>">免费注册</a>] </li><?php else: ?>
...
<script type="text/javascript">
	...
	$('form').submit(function(){
		...
		$(this).ajaxSubmit({
			url:"<?php echo U('registbyemail');?>",//指定表单的提交地址
